    ...
    methods: {
        ...
        fill() {
            if (process.env.NODE_ENV === "development") {
                ...
                $('[name="step5[Линии терапии][0][Комментарий]').val(
                    "улучшилось"
                );

                $(
                    '[name="step5[Линии терапии][0][Обследования][0][Дата]"]'
                ).val("2020-10-07");
                $('[name="step5[Линии терапии][0][Обследования][0][Тип]"]').val(
                    "МСКТ"
                );
                $(
                    '[name="step5[Линии терапии][0][Обследования][0][Объект]"]'
                ).val("головного мозга");
                $(
                ...
                $(
                    '[name="step5[Линии терапии][0][ОАК][Мочевина крови][N]"]'
                ).val(_.random(1.2, 5.6).toFixed(2));
                $(
                    '[name="step5[Линии терапии][0][ОАК][Креатинин крови][Значение]"]'
                ).val(_.random(1.2, 5.6).toFixed(2));
                $(
                    '[name="step5[Линии терапии][0][ОАК][Креатинин крови][N]"]'
                ).val(_.random(1.2, 5.6).toFixed(2));
                $(
                    '[name="step5[Линии терапии][0][ОАК][Общий белок][Значение]"]'
                ).val(_.random(1.2, 5.6).toFixed(2));
                $('[name="step5[Линии терапии][0][ОАК][Общий белок][N]"]').val(
                    _.random(1.2, 5.6).toFixed(2)
                );
                ...
                $('[name="step5[Линии терапии][0][Констатировано наличие]').val(
                    "частичного ответа"
                );
